...
/miniconda/bin/python3 train.py \
	...
	--scheduler MultiStepLR --decay-milestones 15000 25000 \
	--lr 1e-2 \
	--optimizer NovoGrad \
	--train-data-path data/radio_train_{set_number}.csv \
	...
	--experiment-id radio_domainset_{set_number} \
	--fp16 O2 \
	--epochs 8
"""
...
def main():
    ...
    for v in [0, 10, 1, 2, 9, 3, 8, 4, 5, 6, 7]:
        queue.put(v)
