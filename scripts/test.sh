...
python3 train.py $@ \
  ...
  --val-data-path data/valset_by_rec22122019.csv  # valset17122019/valset_by_rec22122019.csv #data/clean_val.csv data/mixed_val.csv  valset11102019/valset11102019.csv #valset17122019/valset17122019.csv # kontur_calls_micro/kontur_calls_micro.0.csv kontur_calls_micro/kontur_calls_micro.1.csv data/clean_val.csv data/ data/valset17122019/valset17122019.0.csv data/valset17122019/valset17122019.1.csv \
