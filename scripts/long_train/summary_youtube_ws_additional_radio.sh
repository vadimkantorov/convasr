python3 train.py $@ \
  ...
  --checkpoint data/experiments/JasperNetBig_NovoGrad_lr1e-4_wd1e-3_bs1536____summary_youtube_ws_radio/checkpoint_epoch283_iter0505000.pt \
  --fp16 O2 \
  --experiment-name summary_youtube_ws_additional_radio \
  --window-size 0.04 \
