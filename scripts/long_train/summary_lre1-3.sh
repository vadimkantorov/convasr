python3 train.py $@ \
  ...
  --lr 1e-3 \
  --optimizer NovoGrad \
  --train-data-path youtube_lowpass/cut/cut_train.json youtube_gsmfr/cut/cut_train.json youtube_amrnb12200/cut/cut_train.json echomsk6000/cut2/cut2_train.json \
  ...
  --checkpoint data/experiments/JasperNetBig_NovoGrad_lr1e-2_wd1e-3_bs1536____summary/checkpoint_epoch259_iter0389000.pt \
  --fp16 O2 \
  --experiment-name summary_btpm_128 \
  --window-size 0.04 \
  --epochs 1000 --exphtml= #\
