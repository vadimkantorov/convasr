...
TRANSCRIBE='--mono --align --max-segment-duration 4.0'
SUBSET='--align-boundary-words --num-speakers 2 --gap 0.25- --cer 0.0-0.4 --duration 1.5-7.0'
CUT="--dilate 0.1 --sample-rate $SAMPLE_RATE --mono --strip-prefix"
