python3 train.py $@ \
  ...
  --checkpoint data/experiments/JasperNetBig_NovoGrad_lr1e-4_wd1e-3_bs512____youtube_3000h_finetune_same_setup/checkpoint_epoch453_iter0412000.pt \
  ...
  --fp16 O2 \
  --iterations 436000 \
  --experiment-name youtube_3000h_finetune_same_setup \
  --skip-on-epoch-end-evaluation \
  --epochs 1000 --exphtml= #\


# init cp data/experiments/JasperNetBig_NovoGrad_lr1e-4_wd1e-3_bs1536____youtube_3000h_better_pt/checkpoint_epoch261_iter0386713.pt
