python3 train.py $@ \
  ...
  --checkpoint data/experiments/JasperNetBig_NovoGrad_lr1e-4_wd1e-3_bs512____youtube_3000h_selftrain/checkpoint_epoch286_iter0403000.pt \
  ...
  --iterations 453000 \
  --fp16 O2 \
  --experiment-name youtube_3000h_after_selftrain \
  --skip-on-epoch-end-evaluation \
  --epochs 1000 --exphtml= #\

# init pt data/experiments/JasperNetBig_NovoGrad_lr1e-4_wd1e-3_bs512____youtube_3000h_selftrain/checkpoint_epoch286_iter0403000.pt
