python3 train.py $@ \
  ...
  --lr 1e-4 \
  --optimizer NovoGrad \
  --train-data-path unsup_dataset/unsup_dataset_transcripts_simple_morph.csv.json \
  --checkpoint data/experiments/JasperNetBig_NovoGrad_lr1e-4_wd1e-3_bs1536____youtube_3000h_better_pt/checkpoint_epoch261_iter0386713.pt \
  ...
  --iterations 485000 \
  --fp16 O2 \
  --experiment-name youtube_3000h_selftrain_2try_middle_morphy \
