python3 train.py $@ \
  ...
  --checkpoint data/experiments/JasperNetBig_NovoGrad_lr1e-4_wd1e-3_bs512____youtube_3000h_selftrain_2try_simple1M/checkpoint_epoch296_iter0455000.pt \
  ...
  --iterations 485000 \
  --fp16 O2 \
  --experiment-name youtube_3000h_after_selftrain_2try_simple1M \
