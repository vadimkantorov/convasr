python3 train.py $@ \
  ...
  --lr 1e-4 \
  --optimizer NovoGrad \
  --train-data-path unsup_dataset/unsup_dataset_transcripts_simple1M.csv.json \
  --checkpoint data/experiments/JasperNetBig_NovoGrad_lr1e-4_wd1e-3_bs512____youtube_3000h_selftrain_2try_simple1M/checkpoint_epoch281_iter0425000.pt \
  ...
  --iterations 455000 \
  --fp16 O2 \
  --experiment-name youtube_3000h_selftrain_2try_simple1M \
