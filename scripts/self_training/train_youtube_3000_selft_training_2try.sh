python3 train.py $@ \
  ...
  --lr 1e-4 \
  --optimizer NovoGrad \
  --train-data-path unsup_dataset/unsup_dataset_transcripts.csv.json \
  --checkpoint data/experiments/JasperNetBig_NovoGrad_lr1e-4_wd1e-3_bs512____youtube_3000h_selftrain_2try/checkpoint_epoch269_iter0405000.pt \
  ...
  --fp16 O2 \
  --experiment-name youtube_3000h_selftrain_2try \
