...
python3 train.py $@ \
  ...
  --val-data-path data/kfold_splits/chunk13_valset.csv.json --frontend-in-model #--batch-time-padding-multiple 1

#data/experiments/JasperNetBig_NovoGrad_lr1e-2_wd1e-3_bs1536____youtube_3000h/checkpoint_epoch244_iter0351982.pt
#data/experiments/JasperNetBig_NovoGrad_lr1e-2_wd1e-3_bs1536____youtube_3000h/checkpoint_epoch236_iter0335638.pt  WER:  48.04% CER: 21.32%
