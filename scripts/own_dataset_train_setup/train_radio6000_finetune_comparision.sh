python3 train.py $@ \
  ...
  --checkpoint data/experiments/JasperNetBig_NovoGrad_lr1e-2_wd1e-3_bs256____radio_1800h_mixed_train/checkpoint_epoch30_iter0216660.pt \
  ...
  --fp16 O2 \
  --experiment-name radio_1800h_mixed_finetune_comparision \
  --epochs 110 --exphtml= #\
