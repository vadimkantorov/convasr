python3 train.py $@ \
  ...
  --fp16 O2 \
  --experiment-name long-train_bs1024_step2 \
  --checkpoint  data/experiments/JasperNetBig_NovoGrad_lr1e-2_wd1e-3_bs1024____long-train_bs1024/checkpoint_epoch110_iter0198880.pt \
  --epochs 200 #\
