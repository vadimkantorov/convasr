...
python3 transcribe.py -i data/diarization_test --checkpoint data/speechcore/best_checkpoint_and_valset_2508/JasperNetBig_NovoGrad_lr1e-4_wd1e-3_bs512____longtrain_finetune_after_self_train_checkpoint_epoch400_iter0740000.pt --output-json --output-html --max-segment-duration=0 --join-transcript --align-words
