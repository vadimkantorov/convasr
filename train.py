...
def traintest(args):
    ...
    def evaluate_model(epoch = None, batch_idx = None, iteration = None):
        ...
        model.train()
        models.save_checkpoint(os.path.join(args.experiment_dir, f'checkpoint_epoch{epoch:02d}_iter{iteration:07d}.pt'), model.module, optimizer, sampler, epoch, batch_idx) if training else None
